...
logfile = os.path.join(modulePath, 'chronojob_dia_picking.log')
...
try:
    ...
    if userId:
        ...
        logging.info('Calling method chron_transfer_to_dia')
        try:
            res = callOdooFunction(odooObj='stock.picking', functionName='chron_transfer_to_dia')
            if not res:
