...
class TurnPrinter(models.TransientModel):
    _name = 'turn.printer'
    _description = "Turn Printer"
    ...
    def print_turns(self):
        return self.env.ref('hr_adv_working_hours.rds_employee_print_turns').report_action(self) if self.print_format == 'turn' else self.env.ref('hr_adv_working_hours.rds_employee_print_schedule_list').report_action(self)
