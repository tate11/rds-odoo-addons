        ...
        for line in self.line_ids:
            ...
            if amt:
                ...
                if line.option == 'day_after_invoice_date':
                    ...
                    next_first_date = next_date + relativedelta(day=31, months=1)  # Getting 1st of next month
                    next_date = next_first_date + relativedelta(days=line.day_of_the_month, months=line.days//30, day=31)
