...
environment.initENV(**config['XMLRPC'])
...
signals = signals.load_signals(ENV,ENV.execute('mrp.workcenter.signal', 'get_signal_map'))
...
boot_msg += "Database:\n\tType: {},\n\tAddress: {}\n\tUUID: {}\n\n".format('xmlrpc_odoo', conn_dict['url'], conn_dict['uid'])
