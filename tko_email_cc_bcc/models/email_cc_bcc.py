...
class MailComposer(models.TransientModel):
    ...
    email_bcc_ids = fields.Many2many('res.partner', 'mail_compose_message_res_partner_bcc_rel', 'wizard_id', 'partner_bcc_id', string='Email CCN', default=_get_default_bcc_ids)
